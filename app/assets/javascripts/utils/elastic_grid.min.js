(function(g, h, e) {
  ...
  g.Elastislide.prototype = {
    ...
    _addControls: function() {
      var k = this;
      this.$navigation = g('<nav><span class="elastislide-prev icon-chevron-left"></span><span class="elastislide-next icon-chevron-right"></span></nav>').appendTo(this.$wrapper);
...
$(function() {
  ...
  $.fn.elastic_grid = function(G) {
    ...
    u.html('<div class="wagwep-container"><nav id="porfolio-nav" class="clearfix"><ul id="portfolio-filter"></ul></nav></div>');
    var g = "";
      ...
      if (typeof K == "undefined") {} else {
        if (K != "") {
          ...
          var I = $("<a>", {
            ...
            "data-filter": "." + J,
            href: "#",
            "class": "btn btn-sm btn-vita btn-vita-white",
          }).appendTo(i);
          i.appendTo(m)
        }
      }
        ...
        if (typeof G.items[y] === "undefined") {} else {
          ...
          if (urlList.length > 0) {
            for (C = 0; C < urlList.length; C++) {
              ...
              var P = $('<a target="' + M + '"></a>');
              P.addClass("btn btn-vita btn-vita-success link-button");
              if (C == 0) {
                P.addClass("first")
              }
